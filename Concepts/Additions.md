...
## Additions That Move To The New Program

These items are intentionally out of StarGen scope and should migrate with the concept-heavy stack (including Concept Atlas workflows and deep simulation/content systems).

### Moves: generators/simulators/validators

- Planetary Geology / Geophysics Generator
- Climate & Weather Systems (planet-scale)
- Oceanography & Hydrology Module
- Biome Synthesis Engine
- Planet Chemistry & Biochemistry Constraints
- Speciation Pressure / Adaptive Landscape Simulator
- Trait Grammar / Morphology Builder (species)
- Food Web / Trophic Network Generator
- Disease & Epidemiology Simulator (Bio + Civ)
- Economic Simulation (local to interstellar)
- Political Geography & Borders Module
- Diplomacy / Faction Relations Engine
- Internal Politics / Power Bloc Simulator
- Religion / Belief System Generator
- Culture Generator (values, norms, aesthetics)
- Language Family / Linguistics Generator
- Law, Justice & Social Order Systems
- Technology Diffusion & Innovation Model
- Urban Generation / Settlement Morphology
- Architecture & Material Culture Generator
- Military Doctrine & Strategic Balance Module
- Conflict & War Simulator
- Archaeology / Deep Time Remnants Module
- Myth, Legend & Narrative Memory Generator
- Information Systems / Media & Communication Networks
- AI / Synthetic Life / Post-biological Population Module
- Terraforming / Planetary Engineering Module
- Biosphere Impact / Anthropocene Layer
- Time Viewer / Timeline Query System
- Scenario / Premise Generator

### Moves: tools/workflow

- Counterfactual Sandbox
- Retcon Manager
- Lore Contradiction Finder
- Plausibility Heatmap
- Simulation Replay / Time Scrubber
- Branch Merger for World States
- Narrative Hook Extractor
- Diegetic Report Generator
- Perspective Filter
- Uncertainty / Fog-of-Knowledge Layer
- Survey Mission Simulator
- Regional Patch Tool
- Species Niche Occupancy Editor with Suggestions
- Cross-Layer Dependency Graph Viewer
- Worldbuilding Goal Wizard
- Theme / Motif Injector
- Canon Style Guide Enforcer
- Atlas / Gazetteer Auto-Compiler
- Reference Image / Prompt Pack Generator
- Playable Slice Exporter
- Ethos / Assumption Switchboard
