...
| Global hardening F2P and diagnostic engines | `Kopparapu2013`, `Kopparapu2014`, `Obertas2017`, `HeEtAl2020`, `Petit2018`, `Petit2020`, `Laskar2017`, `Tamayo2020`, `FangMargot2013`, `ObertasTamayo2023`, moon, small-body, galaxy, and sentient-source sets above | Added `Docs/ScienceHardeningCompletionPlan.md`, a `ScienceHardeningEngineCatalog`, planet-level Kopparapu 2014 mass-corrected HZ diagnostics, orbit-slot AMD/dynamical-packing/resonance diagnostic fields, formation-trace propagation for those slot diagnostics, and source-marked diagnostic terrestrial-impact moon channels. These are diagnostic-first; active behavior changes remain gated where the source plan requires human review. |
