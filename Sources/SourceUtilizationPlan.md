...
Expected work:
- Expand the new `SmallBodyReservoir` records into export panels and later calibrated population diagnostics. System Viewer now has compact overview/selected-belt readouts, a dedicated reservoir-details section, and focusable large-object subentries, but TNO/Centaur/comet-feeding context still needs export surfaces, separate orbital-family distributions, and population-count caveats before it can support broader mapping.
