...
Expected work:
- Expand the new `SmallBodyReservoir` records into dedicated viewer/export panels instead of continuing to hide TNO/Centaur/comet-feeding context inside asteroid-belt rows.
