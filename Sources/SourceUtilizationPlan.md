...
- Current v0.11 slices add elite/median technology access, invention capacity, adoption-lag pressure, technology-access inequality diagnostics, practical enforcement reach, neutral `0-24` core technology, compressed law level, first-class factions, structured culture/religion signals, and life-biome gating.
