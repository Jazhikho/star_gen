...
public partial class SystemGenerationScreen
{
	...
	private static string BuildSystemStudioBasicsBbCode()
	{
		...
		builder.AppendLine("[color=#9cc4ff]What it means:[/color] A spectral class is a rough star type such as O, B, A, F, G, K, or M.");
		builder.AppendLine("[color=#9cc4ff]What changing it does:[/color] Adding hints pushes the generator toward those star types. For example, more M hints tends to favor cool red dwarfs, while more A or B hints favors hotter, brighter stars.");
		builder.AppendLine();
		...
		builder.AppendLine("[color=#9cc4ff]What changing it does:[/color] Older systems tend to have stars that are farther along in their life cycle. Younger systems lean toward hotter, more active stars and newer surroundings.");
		builder.AppendLine();
