...
public partial class StationSpec : RefCounted
{
	...
	/// <summary>
	/// Whether to generate detailed station designs (hull tonnage, components, classifications).
	/// </summary>
	public bool GenerateDetailedDesign;
	...
	public Dictionary ToDictionary()
	{
		...
		Dictionary data = new()
		{
			...
			["generate_detailed_design"] = GenerateDetailedDesign,
		};
	...
	public static StationSpec FromDictionary(Dictionary data)
	{
		...
		spec.GenerateDetailedDesign = GetBool(data, "generate_detailed_design", false);
