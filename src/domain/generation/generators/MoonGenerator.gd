...
const _moon_physical_generator := preload("res://src/domain/generation/generators/moon/MoonPhysicalGenerator.gd")
const _moon_atmosphere_generator := preload("res://src/domain/generation/generators/moon/MoonAtmosphereGenerator.gd")
const _moon_surface_generator := preload("res://src/domain/generation/generators/moon/MoonSurfaceGenerator.gd")
