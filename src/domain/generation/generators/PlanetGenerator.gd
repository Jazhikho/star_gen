...
const _planet_physical_generator := preload("res://src/domain/generation/generators/planet/PlanetPhysicalGenerator.gd")
const _planet_atmosphere_generator := preload("res://src/domain/generation/generators/planet/PlanetAtmosphereGenerator.gd")
const _planet_surface_generator := preload("res://src/domain/generation/generators/planet/PlanetSurfaceGenerator.gd")
