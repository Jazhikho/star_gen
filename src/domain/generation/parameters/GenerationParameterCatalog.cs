...
public static class GenerationParameterCatalog
{
    ...
    public static List<GenerationParameterDefinition> GetSystemDefinitions()
    {
        return new List<GenerationParameterDefinition>
        {
            ...
            new GenerationParameterDefinition("population_permissiveness", "Settlement Density", string.Empty, GenerationParameterControlType.Number, "Controls colony permissiveness. Low values keep settlement on only the easiest worlds; high values support heavier colonization of harsh moons, sealed habitats, and other technically survivable locations."),
