...
public static class GenerationParameterCatalog
{
    ...
    private static List<GenerationParameterDefinition> BuildSystemDefinitionSet()
    {
        return new List<GenerationParameterDefinition>
        {
            ...
            new GenerationParameterDefinition("comet_nucleus_model", "Comet Nucleus", string.Empty, GenerationParameterControlType.Choice, PlanetaryScienceReferenceCatalog.GetTooltipSummary("comet_nucleus_model")),
            new GenerationParameterDefinition("comet_activity_model", "Comet Activity", string.Empty, GenerationParameterControlType.Choice, PlanetaryScienceReferenceCatalog.GetTooltipSummary("comet_activity_model")),
            new GenerationParameterDefinition("comet_size_scale", "Comet Size Scale", string.Empty, GenerationParameterControlType.Number, PlanetaryScienceReferenceCatalog.GetTooltipSummary("comet_size_scale")),
            new GenerationParameterDefinition("minor_body_population_slope", "Minor-Body Slope", string.Empty, GenerationParameterControlType.Number, PlanetaryScienceReferenceCatalog.GetTooltipSummary("minor_body_population_slope")),
            new GenerationParameterDefinition("planet_disk_radius_scale", "Disk Radius Scale", string.Empty, GenerationParameterControlType.Number, PlanetaryScienceReferenceCatalog.GetTooltipSummary("planet_disk_radius_scale")),
            new GenerationParameterDefinition("planet_dust_to_gas_scale", "Dust-to-Gas Scale", string.Empty, GenerationParameterControlType.Number, PlanetaryScienceReferenceCatalog.GetTooltipSummary("planet_dust_to_gas_scale")),
            new GenerationParameterDefinition("planet_fragmentation_velocity_model", "Fragmentation Model", string.Empty, GenerationParameterControlType.Choice, PlanetaryScienceReferenceCatalog.GetTooltipSummary("planet_fragmentation_velocity_model")),
            new GenerationParameterDefinition("planet_giant_origin_band_model", "Giant Origin Band", string.Empty, GenerationParameterControlType.Choice, PlanetaryScienceReferenceCatalog.GetTooltipSummary("planet_giant_origin_band_model")),
            ...
            new GenerationParameterDefinition("subsurface_habitability_model", "Subsurface Habitability", string.Empty, GenerationParameterControlType.Choice, LifeScienceReferenceCatalog.GetTooltipSummary("subsurface_habitability_model")),
            new GenerationParameterDefinition("dark_biosphere_energy_scale", "Dark-Biosphere Energy", string.Empty, GenerationParameterControlType.Number, LifeScienceReferenceCatalog.GetTooltipSummary("dark_biosphere_energy_scale")),
            new GenerationParameterDefinition("sentient_social_scale_model", "Social Scale Model", string.Empty, GenerationParameterControlType.Choice, SentientScienceReferenceCatalog.GetTooltipSummary("sentient_social_scale_model")),
            new GenerationParameterDefinition("sentient_technology_diffusion_model", "Tech Diffusion Model", string.Empty, GenerationParameterControlType.Choice, SentientScienceReferenceCatalog.GetTooltipSummary("sentient_technology_diffusion_model")),
            new GenerationParameterDefinition("sentient_economic_complexity_model", "Economic Complexity", string.Empty, GenerationParameterControlType.Choice, SentientScienceReferenceCatalog.GetTooltipSummary("sentient_economic_complexity_model")),
            new GenerationParameterDefinition("sentient_legitimacy_model", "Legitimacy Model", string.Empty, GenerationParameterControlType.Choice, SentientScienceReferenceCatalog.GetTooltipSummary("sentient_legitimacy_model")),
            ...
            new GenerationParameterDefinition("major_asteroid_display_count", "Large Objects", string.Empty, GenerationParameterControlType.Number, "Runtime display-selection control.\nChooses how many of the largest eligible belt objects are promoted to inspectable system bodies per belt.", GenerationParameterClassification.RuntimeOrchestrationControl),
            new GenerationParameterDefinition("major_asteroid_min_diameter_km", "Large Object Minimum Diameter", "km", GenerationParameterControlType.Number, "Runtime display-selection control.\nSets the minimum diameter for belt objects that can be promoted to inspectable system bodies.", GenerationParameterClassification.RuntimeOrchestrationControl),
