...
public static class ObjectScienceReferenceCatalog
{
    private static readonly Dictionary<string, ObjectScienceSource> Sources = new()
    {
        ...
        ["balbi2023"] = new ObjectScienceSource(
            "balbi2023",
            "Balbi and Frank (2023), oxygen-rich conditions may be an important late bottleneck for technological civilizations.",
            "https://arxiv.org/abs/2308.01160"),
        ["canupward2006"] = new ObjectScienceSource(
            "canupward2006",
            "Canup and Ward (2006), regular moon systems around giant planets are constrained by circumplanetary-disk formation rather than arbitrary counts.",
            "https://doi.org/10.1038/nature04860"),
    ...
    public static string BuildHelpPanelBbCode()
    {
        ...
        builder.AppendLine("- [color=#9cc4ff]Moon targets versus host class:[/color] The moon target count is not guaranteed. StarGen still caps the final result by host size because small rocky worlds do not support giant-planet moon systems. [Canup & Ward 2006; Heller & Barnes 2013]");
        builder.AppendLine("- [color=#9cc4ff]Civilization bottlenecks versus airless worlds:[/color] If you choose the Technosphere Oxygen Bottleneck model, airless or heavily stripped worlds become much poorer civilization candidates even if other life settings stay permissive. [Balbi & Frank 2023]");
        builder.AppendLine();
        ...
        builder.AppendLine("- [color=#9cc4ff]Comets:[/color] Family and activity let you target short-period inner-system comets or distant long-period icy bodies without pretending they are just asteroids with a different label. [Lamy et al. 2004]");
        builder.AppendLine();
