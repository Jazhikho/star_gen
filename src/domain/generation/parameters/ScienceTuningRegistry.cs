...
public static class ScienceTuningRegistry
{
    ...
    private static Dictionary<string, ScienceTuningEntry> BuildEntries()
    {
        ...
        AddDirectEntry(entries, "planet.volatile_delivery_coefficients", "Volatile delivery coefficients", "snow-line, giant-scattering, reservoir, and inner-delivery modifiers", "scalar", new[] { "raymondizidoro2017", "pascucci2016", "fernandes2019", "izidoro2017", "tanakatakeuchiward2002", "demeocarry2014", "baueretal2017", "kavelaarsetal2023", "bernardinellietal2022" }, "Volatile-delivery coefficients are deterministic tuning around migration, snow-line, giant-scattering, asteroid, comet, and TNO reservoir source context.", "SystemPlanetGenerator", "planet_minor_body_outer_system_bias", "implemented as StarGen tuning; human verification pending", false);
        ...
        AddDirectEntry(entries, "planet.moon_architecture_coefficients", "Moon architecture coefficients", "regular CPD mass budget, captured-orbit style, and architecture labels", "relative weight", new[] { "ronnet2020", "sasaki2010", "szulagyi2018", "jewitthaghighipour2007" }, "Regular CPD moon mass budgets, captured-orbit styling, and architecture labels are deterministic StarGen proxies around reviewed moon-formation and irregular-satellite sources.", "SystemMoonGenerator", "planet_moon_formation_bias", "partly implemented as source-marked proxy; human verification pending", false);
