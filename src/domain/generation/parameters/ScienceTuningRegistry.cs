...
public static class ScienceTuningRegistry
{
    ...
    private static Dictionary<string, ScienceTuningEntry> BuildEntries()
    {
        ...
        AddDirectEntry(entries, "planet.formation_state_coefficients", "Planetary formation-state coefficients", "solid/gas/migration/scattering composite family", "scalar", new[] { "pascucci2016", "fischervalenti2005", "mordasini2007", "lambrechtsjohansen2012", "fernandes2019" }, "Formation-state coefficients translate source-backed formation pressures into deterministic top-down generation state.", "PlanetarySystemState", "planet_gas_giant_formation_model", "implemented as StarGen tuning; human verification pending", false);
        AddDirectEntry(entries, "planet.class_zone_weight_tables", "Planet class zone weight tables", "inner/habitable/outer class-weight dictionaries", "relative weight", new[] { "petigura2013", "fulton2017", "fernandes2019", "kopparapu2013", "kopparapu2014" }, "Planet class zone weights are StarGen deterministic priors shaped by occurrence, HZ, and giant-planet source context.", "SystemPlanetGenerator", "planet_mass_radius_model", "implemented as StarGen tuning; human verification pending", false);
        ...
        AddDirectEntry(entries, "planet.volatile_delivery_coefficients", "Volatile delivery coefficients", "snow-line, giant-scattering, and inner-delivery modifiers", "scalar", new[] { "raymondizidoro2017", "pascucci2016", "fernandes2019" }, "Volatile-delivery coefficients are deterministic tuning around migration, snow-line, and giant-scattering source context.", "SystemPlanetGenerator", "planet_minor_body_outer_system_bias", "implemented as StarGen tuning; human verification pending", false);
