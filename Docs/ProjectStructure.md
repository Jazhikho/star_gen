...
- `src/app/viewer/ObjectViewer.Options.cs`: shared Object Viewer options-dialog and compact bottom-right camera-panel behavior aligned with the Galaxy and System viewers.
