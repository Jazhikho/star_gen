...
- `src/app/system_viewer/SystemInspectorPanel.cs`: System Viewer overview and selection readout, including source-facing `SmallBodyReservoir` family summaries grouped under their current asteroid-belt anchor until a dedicated reservoir viewer/export panel exists.
