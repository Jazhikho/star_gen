...
| `planet_moon_formation_bias` | Galaxy Studio, System Studio | Different moon-formation channels change regular vs captured moon styles. | `canupward2006`, `jewitthaghighipour2007` | `SystemMoonGenerator`, formation traces | Regular-disk and captured-rich settings alter moon family structure. | Existing and expanded. | `valid` |
| `planet_minor_body_outer_system_bias` | Galaxy Studio, System Studio | Outer cold leftovers shift between rockier belts and icier reservoirs. | `demeocarry2013`, `lamy2004` | `PlanetarySystemState`, `SystemAsteroidGenerator`, volatile-delivery logic | Comet-leaning settings increase volatile delivery and icy outer-reservoir bias. | Existing and expanded. | `valid` |
