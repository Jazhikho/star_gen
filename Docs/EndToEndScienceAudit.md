...
| Bland-Hawthorn and Gerhard (2016), local shorthand `Bland2016` / `BlandHawthornGerhard2016` | Partly implemented as the active Milky-Way structural schema anchor. `GalaxyConfig`, `GalaxySpec`, and `GalaxyRealismProfile` now carry thin/thick disk scale lengths and heights, bar half-length, solar-circle radius, circular velocity at the solar circle, and stellar-mass scale; spiral density and bar-region classification use the new disk/bar geometry. `GalaxyMassComponentBudget` now adds diagnostic-only halo, dark matter, baryonic, stellar disk/spheroid/halo, nuclear stellar, cold gas, hot gas, baryon/gas fraction, and local stellar-density fields for audit/export use. `GalaxyRotationCurveDiagnostic` now adds diagnostic-only inner/reference/outer velocity anchors and component velocity contributions. | Still not a full Milky-Way simulator: pattern speed/corotation, calibrated nuclear cluster/disk structure, gravitational potential/orbit integration, source-fitted local mass budget, and non-Milky-Way comparison behavior remain follow-up. |
...
|---|---|---|
| Galaxy schema | Bland-Hawthorn and Gerhard (2016) is partly implemented for first-class Milky-Way structural schema fields: thin/thick disk dimensions, bar half-length, solar-circle radius, circular velocity, stellar mass, diagnostic mass-component budgets, and diagnostic rotation-curve decomposition. | Add calibrated nuclear cluster/disk structure, pattern speed/corotation, gravitational-potential/local-mass calibration, orbit integration, and non-Milky-Way comparison sources before claiming full galaxy-realism closure. |
...
- Galaxy-realism follow-up for Bland-Hawthorn and Gerhard (2016): the first structural schema fields, diagnostic component budgets, and diagnostic rotation-curve decomposition are active, but calibrated dynamics, gravitational potential, local mass-budget fitting, and broader barred-spiral comparison sources remain open before full generator-fit closure
