...
|---|---|---|
| Galaxy schema | Bland-Hawthorn and Gerhard (2016) is partly implemented for first-class Milky-Way structural schema fields: thin/thick disk dimensions, bar half-length, solar-circle radius, circular velocity, stellar mass, and diagnostic mass-component budgets. | Add calibrated nuclear cluster/disk structure, rotation-curve terms, pattern speed/corotation, gravitational-potential/local-mass calibration, and non-Milky-Way comparison sources before claiming full galaxy-realism closure. |
...
- Galaxy-realism follow-up for Bland-Hawthorn and Gerhard (2016): the first structural schema fields and diagnostic component budgets are active, but calibrated dynamics, rotation curves, gravitational potential, local mass-budget fitting, and broader barred-spiral comparison sources remain open before full generator-fit closure
