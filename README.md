...
The current user-facing release version is `0.9d`, while the current internal checkpoint version is `0.8.17.1`. Detailed version history and patch notes live in [VERSION.md](VERSION.md).
